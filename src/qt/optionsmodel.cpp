...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizevizzotopAmount"))
        settings.setValue("nAnonymizevizzotopAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizevizzotopAmount = settings.value("nAnonymizevizzotopAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizevizzotopAmount"))
        SoftSetArg("-anonymizevizzotopamount", settings.value("nAnonymizevizzotopAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizevizzotopAmount:
            nAnonymizevizzotopAmount = value.toInt();
            settings.setValue("nAnonymizevizzotopAmount", nAnonymizevizzotopAmount);
            emit anonymizevizzotopAmountChanged(nAnonymizevizzotopAmount);
            break;
        default:
            break;
        }
