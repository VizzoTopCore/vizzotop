    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a VizzoTop address (e.g. CKPnZKDzaDXqEgKJ4GdUg58gXxgzA7mkny)"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    case WalletModel::AnonymizeOnlyUnlocked:
        QMessageBox::warning(this, tr("Send Coins"),
            tr("Error: Unlock your wallet before to send VizzoTop."),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid vizzotop address"));
        }
        else
        {
