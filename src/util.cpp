...
int nAnonymizevizzotopAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\vizzotop
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\vizzotop
    // Mac: ~/Library/Application Support/vizzotop
    // Unix: ~/.vizzotop
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "vizzotop";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "vizzotop.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "vizzotopd.pid"));
