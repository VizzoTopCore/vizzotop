...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Every solution breeds new problems";
        ...
        assert(hashGenesisBlock == uint256("0x7148920b9a5ed80dc4aaf34fece4e80385e402582ac1609df7912d6db7dfc6f0"));
        assert(genesis.hashMerkleRoot == uint256("0x540bb22367fbf4bafab2e44c225cbd8d2e96b8fd879c941a67031b4dfb24b27a"));

        vSeeds.push_back(CDNSSeedData("vizzotop seed 1", "5.135.76.219"));
        vSeeds.push_back(CDNSSeedData("vizzotop seed 2", "195.201.20.101"));
